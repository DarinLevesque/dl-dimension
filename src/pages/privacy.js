  ...
  render() {
    ...
    return (
      <Layout>
        ...
        <p>Effective date: July 08, 2019</p>

        <p>
          Digital Resume of Darin Levesque ("us", "we", or "our") operates the
          https://darinlevesque.com website (the "Service").
        </p>
        ...
        <p>
          ...
          Digital Resume of Darin Levesque is created with the help of the{' '}
        ...
        <p>
          ...
          our Terms and Conditions, accessible from https://darinlevesque.com
        </p>
        ...
        <p>
          Digital Resume of Darin Levesque uses the collected data for various
          purposes:
        </p>
        <ul>
        ...
        <p>
          Digital Resume of Darin Levesque will take all steps reasonably
        ...
        <p>
          Digital Resume of Darin Levesque may disclose your Personal Data in
          the good faith belief that such action is necessary to:
        </p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>
            To protect and defend the rights or property of Digital Resume of
            Darin Levesque
          </li>
          <li>
        ...
        <ul>
          <li>By email: darin@darinlevesque.com</li>
          <li>
